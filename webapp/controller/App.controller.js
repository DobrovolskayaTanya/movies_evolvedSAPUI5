sap.ui.define([
	...
	return Controller.extend("opensap.movies.controller.App", {
		...
		onPress: function(oEvent){
		    ...
		    //Apply genre filter to calender
		    oRowBinding.filter(oFilterGenre);
		    
		    //Apply city filter for roq appointments
		...
		onAppointmentSelect: function(oAppoinment){
			var oContext = oAppoinment.getBindingContext("movies"),
